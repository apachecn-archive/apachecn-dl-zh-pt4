...
![](images/c152c855-4352-491c-8602-80be5cd3c4d3.png)
...
![](images/b5de7e6a-4c8a-4aed-91da-5d4180b3f9f3.png)
...
![](images/21adcb3c-80af-424f-9cc0-16258a64e071.png)
...
![](images/47dea173-616d-4538-89fd-c376e409ff73.png)
...
![](images/4bffe8e5-599a-424e-8217-abbdee0cc8b2.png)Variable computation graph

前面计算图中的每个圆圈代表一个变量。变量在张量对象、其梯度和对创建它的函数的引用周围形成一层薄薄的包装。下图显示了`Variable`类组件:

![](images/c3cefc1f-2e5c-4d58-a488-f970ea340fa4.png)Variable class
...
![](images/4780c540-f052-46b7-94eb-6580d4ae5814.png)

输入数据点

下图显示了拟合输入数据点的线性模型:

![](images/81c03405-d31a-45b7-9fbd-4de358111092.png)Linear model fitted on input data points
...
![](images/14187b0e-8fa2-415e-a890-6695d3bcae31.png)
...
![](images/e6333f93-736c-4658-957a-180b30f69600.png)
...
![](images/4556ddc4-d0e1-4e0e-a153-c2ec2c779701.png)![](images/7a28a3ad-2d64-4937-9309-5c062885025f.png)
...
![](images/eec87fd4-fe4f-408b-b831-4157206a684f.png)
...
![](images/dd8dabd2-67a6-41f6-85bd-99575eadf301.png)
...
![](images/7f8abb0b-31dc-4e78-a06a-1a29631d7706.png)
...
![](images/c746e70e-bf9a-40be-8f68-7493de1eb7ac.png)

大多数框架在以下面的格式提供时，使阅读图像和给它们贴标签变得更容易。这意味着每个类都应该有一个单独的图像文件夹。这里，所有的猫图像应该在`cat`文件夹中，狗图像应该在`dog`文件夹中:

![](images/bf800adb-ed3e-4f0e-b644-de91d3789ce5.png)
...
![](images/6fc5e3ac-369e-4a9f-bcbc-70395c8ed587.png)
...
![](images/09088b50-3dab-4b63-996f-498a5c52bfe2.png)
