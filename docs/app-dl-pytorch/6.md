<title>C11865_06_ePub_Final_NT</title> <link href="css/epub.css" rel="stylesheet" type="text/css">
...
![Figure 6.2: Amazon’s Alexa](image/C11865_06_02.jpg)
...
![Figure 6.3: Google’s Pixel Buds](image/C11865_06_03.jpg)
...
![Figure 6.4: The forecasting of monthly sales (qty)](image/C11865_06_04.jpg)
...
![Figure 6.5: Image recognition using RNNs](image/C11865_06_05.jpg)
...
![Figure 6.6: A graphical representation of a network, where A shows a feedforward neural network and B shows an RNN](image/C11865_06_06.jpg)
...
![Figure 6.7: An RNN computation for each prediction](image/C11865_06_07.jpg)
...
![Equation 6.8: A mathematical computation of traditional RNNs](image/C11865_06_08.jpg)
...
![Figure 6.9: LSTM network gates](image/C11865_06_09.jpg)
...
![Equation 6.10: The mathematical computations that occur in the learn gate](image/C11865_06_10.jpg)
...
![Equation 6.11: The mathematical computations that occur in the forget gate](image/C11865_06_11.jpg)
...
![Equation 6.12: The mathematical computation that occurs in the remember gate](image/C11865_06_12.jpg)
...
![Equation 6.13: The mathematical computations that occur in the use gate](image/C11865_06_13.jpg)
...
![Figure 6.14: A LSTM network process through time](image/C11865_06_14.jpg)
...
![Equation 6.15: The mapping of characters and numbers](image/C11865_06_15.jpg)
...
![Figure 6.16: Batch generation for RNNs](image/C11865_06_16.jpg)
...
![Figure 6.17: A representation of the batches for X and Y](image/C11865_06_17.jpg)
...
![Equation 6.18: One-hot matrix dimensions](image/C11865_06_18.jpg)
...
![Figure 6.19: An example of a tweet](image/C11865_06_19.jpg)
...
![Equation 6.20: The mapping of words and numbers](image/C11865_06_20.jpg)
...
在接下来的活动中，将使用 LSTM 网络来分析一组评论，以确定其背后的情绪。让我们考虑以下场景:你在一家互联网提供商的公共关系部门工作，审查你在该公司社交媒体档案上收到的每个查询的过程需要相当长的时间。最大的问题是，对服务有问题的客户比没有问题的客户更没有耐心，所以你需要优先考虑你的回应，这样你就可以先解决它们。由于您喜欢在空闲时间编程，您决定尝试构建一个能够确定消息是积极还是消极的神经网络:
