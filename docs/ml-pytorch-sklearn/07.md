...
在这一章中，我们将关注使用**多数表决**原则的最流行的集成方法。多数投票仅仅意味着我们选择已经被大多数分类器预测的类别标签，也就是说，获得超过 50%的投票。严格地说,“多数表决”一词仅指二元类设置。然而，很容易将多数投票原则推广到多类别设置中，这被称为 T4 多数投票。(在英国，人们分别通过“绝对”和“相对”多数来区分多数和多数投票。)
...
在我们深入 AdaBoost 算法的具体细节之前，让我们看一下*图 7.9* ，以便更好地理解 AdaBoost 背后的基本概念:
