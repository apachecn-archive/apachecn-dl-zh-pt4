...
我们可以看到，如果 *z* 趋向无穷大( *z* →∞),则![](img/B17582_02_039.png)趋近于 1，因为*e*^–^z 对于 *z* 的大值变得非常小。类似地，![](img/B17582_02_039.png)趋向于 0，因为的分母越来越大。因此，我们可以得出结论，这个 sigmoid 函数将实数值作为输入，并将其转换为范围[0，1]内的值，截距为![](img/B17582_03_012.png)。
