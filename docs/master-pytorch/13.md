...
在前面的章节中，我们遇到了监督学习的例子，例如使用 MNIST 数据集建立一个分类器来分类手写数字。我们还探索了无监督学习，同时使用未标记的文本语料库建立文本生成模型。
...
![Figure 9.1 – Reinforcement learning schematic ](Images/B12158_09_01.jpg)
...
![Figure 9.2 – Pong video game](Images/B12158_09_02.jpg)
...
![Figure 9.3 – Q-learning example environment ](Images/B12158_09_03.jpg)
...
![Figure 9.4 – Epsilon-greedy-action mechanism](Images/B12158_09_04.jpg)
...
![](Images/Formula_09_003.jpg)

除了引入了一个新术语![](Images/Formula_09_004.png) (theta)，这个等式与 Q-learning 的等式基本相同。![](Images/Formula_09_005.png)表示 DQN 模型用于获取 Q 值的 DNN 的权重。但是这个等式有点奇怪。

请注意，![](Images/Formula_09_006.png)位于等式的左侧和右侧。这意味着在每一步，我们都使用相同的神经网络来获得当前状态-动作对以及下一个状态-动作对的 Q 值。这意味着我们正在追逐一个不稳定的目标，因为每一步![](Images/Formula_09_007.png)都将被更新，这将改变下一步等式的左侧和右侧，从而导致学习过程的不稳定性。
...
![Figure 9.5 – DQN training logs](Images/B12158_09_05.jpg)

图 9.5-DQN 培训日志

此外，下图显示了当前奖励、最佳奖励和平均奖励的进度，以及 epsilon 值与剧集进度的关系:

![Figure 9.6 – DQN training curves](Images/B12158_09_06.jpg)

图 9.6-DQN 训练曲线

下图显示了在训练过程中 epsilon 值是如何随着发作而降低的:

![Figure 9.7 – Epsilon variation over episodes](Images/B12158_09_07.jpg)
