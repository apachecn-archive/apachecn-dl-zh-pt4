...
![Figure 3.5 – CNN architecture evolution – a broad picture](Images/B12158_03_05.jpg)
...
![Figure 3.6 – LeNet architecture](Images/B12158_03_06.jpg)
...
2.  Next, we will define the model architecture based on the outline given in *Figure 3.6*:
    ...
    ![Figure 3.7 – LeNet PyTorch model object](Images/B12158_03_07.jpg)
...
5.  Before we get on to training the model, we need to load the dataset. For this exercise, we will be using the `CIFAR-10` dataset.
    ...
    ![Figure 3.8 – CIFAR-10 dataset download](Images/B12158_03_08.jpg)
...
![Figure 3.9 – CIFAR-10 dataset samples](Images/B12158_03_09.jpg)
...
1.  We will define `optimizer` and start the training loop as shown here:
    ...
    ![Figure 3.10 – Training LeNet](Images/B12158_03_10.jpg)
...
1.  Let's make predictions by loading the saved model and running it on the test dataset:
    ...
    ![Figure 3.11 – LeNet predictions](Images/B12158_03_11.jpg)
...
2.  Finally, we will check the overall accuracy of this model on the test dataset as well as per class accuracy:
    ...
    ![Figure 3.12 – LeNet overall accuracy](Images/B12158_03_12.jpg)
...
![Figure 3.13 – LeNet per class accuracy](Images/B12158_03_13.jpg)
...
![Figure 3.14 – AlexNet architecture](Images/B12158_03_14.jpg)
...
1.  Let's visualize some sample training dataset images:
    ...
    ![Figure 3.15 – Bees versus ants dataset](Images/B12158_03_15.jpg)
...
5.  We can visualize these components as shown here:
    ...
    ![Figure 3.16 – AlexNet feature extractor](Images/B12158_03_16.jpg)
...
6.  Now, we will run the `classifier` feature as follows:
    ...
    ![Figure 3.17 – AlexNet classifier](Images/B12158_03_17.jpg)
...
8.  And now, we are all set to define the optimizer and loss function, and thereafter run the training routine as follows:
    ...
    ![Figure 3.18 – AlexNet fine-tuning loop](Images/B12158_03_18.jpg)
...
![Figure 3.19 – AlexNet predictions](Images/B12158_03_19.jpg)
...
![Figure 3.20 – VGG16 architecture](Images/B12158_03_20.jpg)
...
4.  Once downloaded, we need to create a mapping between the class indices 0 to 999 and the corresponding class labels, as shown here:
    ...
    ![Figure 3.21 – ImageNet class mappings](Images/B12158_03_21.jpg)
...
6.  Load the pretrained `VGG13` model:
    ...
    ![Figure 3.22 – Loading the VGG13 model](Images/B12158_03_22.jpg)
...
![Figure 3.23 – VGG13 predictions](Images/B12158_03_23.jpg)
...
![Figure 3.24 – GoogLeNet architecture](Images/B12158_03_24.jpg)
...
![Fig 3.25 – Inception v3 architecture](Images/B12158_03_25.jpg)
...
![Figure 3.26 – Skip connections](Images/B12158_03_26.jpg)
...
![Figure 3.27 – ResNet architecture](Images/B12158_03_27.jpg)
...
![Figure 3.28 – DenseNet architecture](Images/B12158_03_28.jpg)
...
![Figure 3.29 – ResNeXt architecture](Images/B12158_03_29.jpg)
