...
![Figure 5.1 – Transformer model architecture](Images/B12158_05_01.jpg)
...
![Figure 5.2 – Self-attention layer](Images/B12158_05_02.jpg)
...
![Figure 5.3 – Multi-head attention layer with two self-attention units](Images/B12158_05_03.jpg)
...
3.  Finally, we must run the model training loop. For demonstration purposes, we are training the model for `5` epochs, but you are encouraged to run it for longer in order to get better performance:
    ...
    ![Figure 5.4 – Transformer training logs](Images/B12158_05_04.jpg)
...
![Figure 5.5 – Transformer evaluation results](Images/B12158_05_05.jpg)
...
![Figure 5.6 – RandWireNN data loading](Images/B12158_05_06.jpg)
...
![Figure 5.7 – RandWireNN training logs](Images/B12158_05_07.jpg)
...
1.  Once the model has been trained, we can evaluate it on the test set:
    ...
    ![Figure 5.8 – RandWireNN evaluation results](Images/B12158_05_08.jpg)
...
![Figure 5.9 – RandWireNN architecture](Images/Figure_05_09.jpg)
