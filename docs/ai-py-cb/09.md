...
对于 WaveGAN，他们将 2D 卷积展平为 1D，同时保持大小不变(例如，5x5 的内核变成了 25 的 1D 内核)。2x2 的步幅变成了 4。他们移除了批次标准化层。他们使用 Wasserstein GAN-GP 策略进行训练(Ishaan Gulrajani 等人，2017；瓦塞尔斯坦GAN的 Im *探明训练；【https://arxiv.org/abs/1704.00028】[。](https://arxiv.org/abs/1704.00028)*
