<title>Image Segmentation</title> <link rel="stylesheet" href="css/style.css" type="text/css">  Image Segmentation
...
![](assets/3a662686-bb2c-4d6c-b086-9f4381e83d89.png)
...
![](assets/940dbb7a-95b0-4e28-b50e-e1521e3c048d.png)
...
![](assets/134a4873-5c45-4981-8a5d-059c305f0a69.png)
...
![](assets/be10ec04-dd13-4bc0-b7e4-2d577d215b79.png)
...
![](assets/8d9656e4-2097-4b3d-8827-09d4cf222e6c.png)
...
![](assets/f1205907-1a7d-4939-bff3-dc1a78ed26e6.png)
...
![](assets/75b7e809-5fb7-4de6-8e6e-d325b8277b28.png)
...
![](assets/536baf37-d06d-47e6-82cd-d845e6e651da.png)

在上图中，请注意，我们从一个层获取类和边界框信息，从另一个层获取遮罩信息。

Mask R-CNN 架构的工作细节如下:

![](assets/caeb6898-db1a-4b66-b70f-0581b50e34ce.png)
...
![](assets/49f8e1ab-e011-4b49-b55f-01875f3a3567.png)
...
![](assets/adc81e54-0de8-4e36-b3a0-dfdd91678580.png)
...
![](assets/574531c5-40c6-428f-951a-7eecbd59a29f.png)

2.  在每个 2 x 2 单元格内定义四个等距点:

![](assets/c2618485-95cf-46d8-b689-9fa759addefc.png)

请注意，在上图中，两个连续点之间的距离是 0.75。

3.  根据每个点到最近已知值的距离计算每个点的加权平均值:

![](assets/46ac69d8-08b8-49f9-8b5e-190674cbf2f7.png)

4.  对像元中的所有四个点重复上述插值步骤:

![](assets/bcf3f6af-db02-4ee5-84a9-71011d3e5a80.png)

5.  在一个单元格内的所有四个点上执行平均汇集:

![](assets/05dbd0a6-d3d5-4d9b-af09-73d4214ab976.png)

通过实施上述步骤，我们在执行 RoI 对齐时不会丢失信息；也就是说，当我们把所有的区域放在同一个形状里面。
...
![](assets/79329155-e234-4eb7-93b5-267c015ed22f.png)
...
![](assets/ee19641c-c70b-462a-836f-0576b50157aa.png)
...
![](assets/020590de-c661-4c5c-9eba-989fa3afe87f.png)
...
![](assets/ab8dd49c-a49b-42f9-9e88-fc28817128c7.png)
...
![](assets/af158d52-9b2a-4960-801f-585a5cd0abe3.png)
...
![](assets/10e09327-e5fd-41db-8032-405ad00431ac.png)
...
![](assets/c4b2af21-85f5-48f0-9450-6222e1911948.png)
...
![](assets/2b2cf033-d09b-42b7-9bc0-2eef4e30dde4.png)
...
![](assets/6ce9b8be-5e45-4c41-8d9f-9cfbec07b333.png)
...
![](assets/466bc609-0051-4f1d-b695-fb0fb39cdf41.png)

此外，包含人和桌子的样本图像的预测片段如下:

![](assets/59453668-ce81-4efe-94a0-2fd2fb4e1e5b.png)
