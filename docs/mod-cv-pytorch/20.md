<title>Combining Computer Vision and Reinforcement Learning</title> <link rel="stylesheet" href="css/style.css" type="text/css">  Combining Computer Vision and Reinforcement Learning
...
![](assets/1b2905ab-5a6d-4124-ad5b-3b27b3a289c2.png)
...
![](assets/0fd24540-b483-47e9-8f7a-b7111e69040f.png)

有了前面的等式，让我们计算所有单元格的值(**)一旦确定了一个状态中的最优动作**)，γ的值为 0.9(γ的典型值在 0.9 和 0.99 之间):

![](assets/368799b1-de45-47cc-8491-3fd63aebd25d.png)

从前面的计算中，我们可以理解如何计算给定状态(单元)中的值，当给定该状态中的最佳动作时。下面是我们到达终端状态的简单场景:

![](assets/ebac2fa5-8872-41bf-bce8-1e09d8cec223.png)
...
![](assets/9691243e-fefe-4d0a-b5a5-0b8684793c52.png)
...
![](assets/6ca78767-0133-4758-8682-66a7ad091433.png)
...
![](assets/ef2f7e6a-3cce-4c5f-bc0d-82d159c7fc47.png)
...
![](assets/4da677ad-5eb9-4c83-8de4-b9c29e0893b1.png)

我们已经知道，我们必须保持**更新**给定状态的状态动作值，直到它饱和。因此，我们将修改前面的公式，如下所示:

![](assets/93b20603-00cd-4ccc-ad0e-6ae33c422b8f.png)

在前面的等式中，我们用学习率代替 1，这样我们就可以更加渐进地更新在某个状态下采取的动作的值:

![](assets/57319995-89cc-4d34-b468-55617d3c13f9.png)
...
![](assets/44806a62-0415-4f49-867d-8bc7da42f629.png)
...
![](assets/c2a4a7b4-03d7-4755-a603-a3ff0d25baaa.png)
...
![](assets/b8094ac4-0e5b-4a81-ba14-e778bd3ec4e4.png)
...
![](assets/9aa1c86f-6ae5-41cd-82e7-74bbd8053234.png)
...
![](assets/9197d60f-cb98-427d-ab1b-ccbeb34f9009.png)
...
![](assets/0f62faec-ec9a-4469-ac74-979738c0631a.png)
...
![](assets/5c7eb3d6-465b-43c7-ad5e-5d6e60e53034.png)
...
![](assets/354fa556-04b9-448b-aaa4-4660a6e7d35f.png)
...
![](assets/ebdb3d6b-712c-440b-9922-aae9f8bb8fb7.png)
...
![](assets/e3cd6a8b-0642-4e96-b369-fd5cf745ab3a.png)
...
![](assets/cb5b3b21-80f5-4049-8ab3-267bae40d934.png)
