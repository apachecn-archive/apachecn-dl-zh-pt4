<title>Data Science - A Birds' Eye View</title>  
...
<title>Understanding data science by an example</title>  
...
<title>Design procedure of data science algorithms</title>  
...
<title>Evaluating your model</title>  
...
<title>Getting to learn</title>  

# 开始学习

构建机器学习系统伴随着一些挑战和问题；我们将在本节中尝试解决这些问题。这些问题中有许多是特定于领域的，而另一些则不是。

<title>Challenges of learning</title>  

# 学习的挑战

下面是你在试图建立一个学习系统时通常会面临的挑战和问题的概述。

<title>Feature extraction – feature engineering</title>  
...
<title>Selection of a machine learning algorithm</title>  
...
<title>Implementing the fish recognition/detection model</title>  
...
<title>Knowledge base/dataset</title>  
...
<title>Data analysis pre-processing</title>  
...
<title>Data size and industry needs</title>  
