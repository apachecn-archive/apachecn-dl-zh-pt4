<title>Neural Sentiment Analysis</title>  
...
然后，我们可以添加第一个递归层，我们将使用所谓的**门控递归单元** ( **GRU** )。通常，你会看到人们使用所谓的 **LSTM** ，但其他人似乎认为 GRU 更好，因为 LSTM 内有多余的门。事实上，更简单的代码使用更少的门也能很好地工作。你可以给 LSTM 增加一千个大门，但这并不意味着它会变得更好。
